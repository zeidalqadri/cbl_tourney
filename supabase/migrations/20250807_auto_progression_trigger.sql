-- Auto-progression trigger for tournament_matches
-- This ensures winners automatically advance to next rounds

-- Create or replace the auto-progression function
